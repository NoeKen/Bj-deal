...
export default {
  ...
  checkboxBgColor: '#f4562a',
  checkboxSize: 20,
  checkboxTickColor: '#fff',

  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#ff763b' : '#f4562a',
  brandInfo: '#ff763b',
  brandSuccess: '#5cb85c',
  brandDanger: '#de5b49',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#f4562a',
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#737373' : '#bfc6ea',
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? '#f4562a' : '#fff',
  sTabBarActiveTextColor: '#f4562a',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#f4562a' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#f4562a',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#f4562a' : '#fff',
  ...
  toolbarBtnTextColor: platform === PLATFORM.IOS ? '#f4562a' : '#fff',
  ...
  listNoteSize: 13,
  listItemSelected: platform === PLATFORM.IOS ? '#f4562a' : '#c54622',
  ...
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#f4562a' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#f4562a' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : '#c54622',
  segmentBorderColor: platform === PLATFORM.IOS ? '#f4562a' : '#fff',
  ...
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? '#f4562a' : '#fff',
  topTabBarBorderColor: platform === PLATFORM.IOS ? '#a7a6ab' : '#fff',
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? '#f4562a' : '#fff',
